...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ADI_MAXM86161_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_LIS2DTW12_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ZEPHYR_BT_HCI_ENTROPY_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAXM86161, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAXM86161_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAXM86161_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DTW12, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DTW12_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LIS2DTW12_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_TGM_FIRMWARE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PCB00003, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PCB00003_NRF52832, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0x37000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PPG_SAMPLES_PER_FRAME, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ACC_SAMPLES_PER_FRAME, 25);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BATTERY_MEASUREMENT_INTERVAL, 300);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TEMPERATURE_MEASUREMENT_INTERVAL, 1);
